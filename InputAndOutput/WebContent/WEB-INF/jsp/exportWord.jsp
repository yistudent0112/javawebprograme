			...
			<div class="right">
				...
				<div class="rightCont">
					...
					<table class="tab1" width="100%">
						<tbody>
							<tr>
								...
								<td width="30%"><input name="age" 
									class="allInput" style="width: 100%;" type="text" /></td>
							</tr>
							<tr>
								<td align="right" width="10%">时间<font color="red">*</font>：
								</td>
								<td width="30%"><input name="time" 
									class="allInput" style="width: 100%;" type="text" /></td>
					...
					<div style="text-align: center; margin-top: 30px;">
						<input class="tabSub" value="导出03" type="button" onclick="document.getElementById('mainForm').submit()"/>&nbsp;&nbsp;&nbsp;&nbsp;
						<input class="tabSub" value="导出07" type="button" onclick="document.getElementById('mainForm').submit()"/>
					</div>
				</div>
			</div>
		</form>
